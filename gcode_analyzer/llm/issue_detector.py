...
- END 구간의 온도 0 설정은 정상
- START 구간의 예열 대기는 정상
- **주석 라인(;로 시작)은 분석 대상이 아님** - 무시하세요
- M106/M107은 팬 제어 명령이므로 온도 분석에서 제외
...
**중요**: 주석 라인(;로 시작)은 분석 대상이 아닙니다. 실제 G-code 명령어만 분석하세요.
...
**중요**: 주석 라인(;로 시작)은 G-code 명령이 아닙니다. 구조 분석에서 제외하세요.
